                          ...
                          const Vector3f &dir, float &tnear, float &u, float &v)
{
    ...
    float deno = 1.0 / dotProduct(S1, E1);
    float t = deno * dotProduct(S2, E2);
    float b1 = deno * dotProduct(S1, S);
    float b2 = deno * dotProduct(S2, dir);
    if (t >= 0 && b1 > 0.0 && b2 > 0.0 && (1 - b1 - b2) > 0.0)
    {
        tnear = t;
        u = b1;
        v = b2;
